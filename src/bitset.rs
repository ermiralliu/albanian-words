...
//
// pub const FIRST_PASS: Bitset256 = Bitset256 { field1: ARR };
//
...
//
//         let val = self.field1[lane];
//         (val >> bit_within_lane) & 1 == 1
//     }
//
//     #[inline(always)]
//     pub fn get_first_pass_type(&self, index: u8) -> FirstPassType {
...
//
//         assert!(lane < 4);
//         let val = unsafe { self.field1.get_unchecked(lane) };
//
...
//     //
//     // #[inline]
//     // pub fn get_second_pass_type(&self, index: u8) -> SecondPassType {
//     //     let index = index as usize;
//     //     let lane = index / 64;
//     //     let bit_within_lane = index % 64;
//     //
//     //     let is_xcc_bit = (index == 0xCC) as usize;
...
//     //     let res = (a << special) as usize;
//     //     let result = (res + is_xcc_bit) & final_mask;
//     //
